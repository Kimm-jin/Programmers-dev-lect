...
public class BoardApiController {
    ...
    public void saveBoard(
        ...
        boardService.saveBoard(userDetails.getUsername(), dto.getTitle(), dto.getContent(), dto.getFile());
    }
    ...
    public void updateBoard(
        ...
        boardService.updateBoard(id, userDetails.getUsername(), dto);
    }
    ...
    public void deleteBoard(
        ...
        boardService.deleteBoard(id, userDetails.getUsername(), dto);
    }
