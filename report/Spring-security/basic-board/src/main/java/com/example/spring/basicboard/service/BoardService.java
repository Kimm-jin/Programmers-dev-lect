...
import com.example.spring.basicboard.exception.BoardAccessDeniedException;
...
public class BoardService {
    ...
    @Transactional
    public void updateBoard(long id, String loginUserId, BoardUpdateRequestDto dto) {
    ...
    @Transactional
    public void deleteBoard(long id,String loginUserId ,BoardDeleteRequestDto dto) {
