...
// 그래서 아래 필드 이름은 화면 홈의 name 속성과 "똑같아야" 한다.
// @Setter / @NoArgsConstructor
// - @ModelAttribute는 "기본 생성자로 객체를 만든 뒤 setter로 값을 하나씩 채우는" 방식이다.
// - 그래서 응답 DTO들처럼 @Bulder만 있으면 안 되고, @Setter / @NoArgsConstructor 가 있어야 한다.
...
public class BoardWriteRequestDto {
    ...
    // MultipartFile
    // mulitpart/form-data 로 업로드된 "파일 한 개"를 스프링이 감싸서 넘겨주는 타입이다.
