// * 예외처리 - 개발자가 예측할 수 없는 오류
// 프로그램 실행 중에 발생할 수 있는 오류(예외)를 처리하여, 프로그램이 갑자기 멈추지 않도록 하는 방법이다.
// 예외가 발생해도 프로그램이 정상적으로 흐름을 이어가거나, 안전하게 마무리 할 수 있게 해준다.
...
public class B_try_catch {
    ...
    public static void exam2(){
        ...
        } catch (Exception e){ // 어떤 예외일지 모를 경우
    ...
    public static void exam5(){
        ...
        // 위 try가 끝나면(정상이든 예외든) fis.close()가 자동 호출된다.
    }
