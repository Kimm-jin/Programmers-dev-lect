...
// 이렇게 하면 이점으로 객체 내부의 상태가 무분별하게 변경되는 것을 막을 수 있다.
// 2. 접근 제어자
// 자바에서는 private, protected, public 등의 접근 제어자를 사용하여 클래스 맴버(필드와 메서드)에 대한 접근 권한을 제어한다.
// 이를 통해 어떤 클래스가 특정 맴버에 접근할 수 있는지를 정의한다.
// 3. Getter와 Setter
...
public class J_encapsulation {
    ...
    // setter 메서드 : 외부에서 name필드의 값을 설정할 수 있도록 허용
    ...
    // getter, setter은 공식적인건 아니지만 암묵적으로 이렇게 사용함
