...
// * 메서드 선언부 : 메서드 선언부는 '메서드의 이름'과 '메개변수 선언', 그리고 '반환타입'으로 구성되어 있으며
//  메서드가 작업을 수행하기 위해 어떤 값들을 필요로 하고 작업의 결과로 어떤 타입의 값을 반환하는지에 대한 정보를 제공한다.

/*
    public int add(int a, int b) -> 선언 부
    {
        -> 구현부
        return a+b;
    }
...
// * 메서드 호출 : 메서드를 정의 했어도 호출되지 않으면 아무 일도 일어나지않는다.
/*
...
public class B_method {
    public static void main(String[] args) {
        B_calculator cal = new B_calculator();
